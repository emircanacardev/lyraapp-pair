...
object LyraIcons {
    ...
    // ── Oynatıcı kontrol ikonları (PlayerScreen) ──

    /** Oynat (Material PlayArrow). */
    ...
    /** 10 saniye geri (Material FastRewind). */
    ...
    /** 10 saniye ileri (Material FastForward). */
